  ...
  Widget reaction() {
    return ReactionButton<String>(
      onReactionChanged: (Reaction<String>? reaction) {
        ...
        _emojiShowing = true; // Hide the reactions after selecting one
        });
      },
      ...
      selectedReaction: Reaction<String>(
        value: selectedEmoji,
        icon: Text(selectedEmoji, style: TextStyle(fontSize: 24)),
      ),
    );
  }
...
if(_emojiShowing)
  reaction(),
                    ...
                    // Display the reaction widget when _emojiShowing is true
                  ],
                ),
              ),
            ],
